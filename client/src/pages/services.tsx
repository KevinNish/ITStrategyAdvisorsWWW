          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                A fractional CIO provides part-time, strategic technology leadership to Canadian organizations that need C-level expertise but don't require or can't afford a full-time executive.
              </p>
      ...
      <section className="py-16 bg-vcio-secondary text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Let's discuss how our vendor-agnostic fractional CIO services can drive your business forward.
          </p>
          <Link href="/contact">
